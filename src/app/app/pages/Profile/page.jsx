...
import { User, Calendar, Users, MapPin, Edit, Save, Loader, ShieldCheck, Image as ImageIcon, Lock, Eye, EyeOff } from 'lucide-react';
...
export default function ProfilePage() {
    ...
    if (loading || authLoading) return <div className="flex justify-center items-center h-screen"><Loader className="animate-spin text-blue-500" size={48} /></div>;
    if (!userData) return <div className="text-center mt-10 p-4">No se encontraron datos del perfil. Intenta recargar la página.</div>;
